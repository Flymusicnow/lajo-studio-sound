...
const translations: Record<Language, Record<string, string>> = {
  sv: {
    ...
    'pricing.subtitle': 'Bygg din session och se priset direkt',
    'pricing.configurator.title': 'Prisberäknare',
    'pricing.service': 'Tjänst',
    'pricing.service.recording': 'Inspelning',
    'pricing.service.mixing': 'Mixning',
    'pricing.service.mastering': 'Mastering',
    'pricing.service.production': 'Produktion',
    'pricing.package': 'Paket',
    'pricing.package.basic': 'Basic',
    'pricing.package.premium': 'Premium',
    'pricing.package.highend': 'High-End',
    'pricing.package.recommend': 'Rekommenderat',
    'pricing.tracks': 'Antal spår',
    'pricing.tracks.0-30': '0–30 spår',
    'pricing.tracks.31-60': '31–60 spår',
    'pricing.tracks.61-100': '61–100 spår',
    'pricing.tracks.100+': '100+ spår',
    'pricing.delivery': 'Leverans',
    'pricing.delivery.standard': 'Standard (5–7 dagar)',
    'pricing.delivery.priority': 'Prioriterad (2–3 dagar)',
    ...
    'pricing.revisions': 'revisioner',
    'pricing.unlimited': 'Obegränsade revisioner',
    'pricing.stereo': 'Stereo Mastering',
    'pricing.hybrid': 'Hybrid Mastering',
    'pricing.stem': 'Stem Mastering',
    'pricing.halfday': 'Halvdag (4h)',
    'pricing.fullday': 'Heldag (8h)',
    'pricing.weekend': 'Helg',
    'pricing.exclusive': 'Exklusiv beat/produktion',
  },
  en: {
    // Navigation
    'nav.home': 'Home',
    ...
    'pricing.subtitle': 'Build your session and see the price',
    'pricing.configurator.title': 'Price Calculator',
    'pricing.service': 'Service',
    'pricing.service.recording': 'Recording',
    'pricing.service.mixing': 'Mixing',
    'pricing.service.mastering': 'Mastering',
    'pricing.service.production': 'Production',
    'pricing.package': 'Package',
    'pricing.package.basic': 'Basic',
    'pricing.package.premium': 'Premium',
    'pricing.package.highend': 'High-End',
    'pricing.package.recommend': 'Recommended',
    ...
    'pricing.tracks.100+': '100+ tracks',
    'pricing.delivery': 'Delivery',
    'pricing.delivery.standard': 'Standard (5–7 days)',
    'pricing.delivery.priority': 'Priority (2–3 days)',
    'pricing.total': 'Total',
    'pricing.from': 'From',
    ...
    'pricing.hybrid': 'Hybrid Mastering',
    'pricing.stem': 'Stem Mastering',
    'pricing.halfday': 'Half-day (4h)',
    'pricing.fullday': 'Full-day (8h)',
    'pricing.weekend': 'Weekend',
    'pricing.exclusive': 'Exclusive beat/production',
  },
};
